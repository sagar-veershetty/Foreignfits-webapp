...
-- Insert default users (password is 'admin123', 'sales123', 'warehouse123' respectively)
-- Using BCrypt hash for 'admin123', 'sales123', 'warehouse123'
INSERT INTO users (id, name, email, password, role, is_active, created_at, updated_at) VALUES
(1, 'Admin User', 'admin@foreignfits.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'ADMIN', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'Sales Representative', 'sales@foreignfits.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'SALES', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'Warehouse Manager', 'warehouse@foreignfits.com', '$2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'WAREHOUSE', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
