...
-- Insert default locations (1 supplier, 3 warehouses and 2 stores)
INSERT INTO locations (id, name, type, address, city, state, zip_code, phone, manager, capacity, is_active, created_at, updated_at) VALUES
...
(2, 'Gaumukh Warehouse', 'WAREHOUSE', 'Auradkar House, New Adarsh Colony', 'Bidar', 'Karnataka', '585401', '+91-8050026166', 'Warehouse Manager', 10000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(5, 'Gangotri Warehouse', 'WAREHOUSE', 'New Adarsh Colony', 'Bidar', 'Karnataka', '585401', '+91-8050026166', 'Warehouse Manager', 10000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 'Yamunotri Warehouse', 'WAREHOUSE', 'Kicha House, New Adarsh Colony', 'Bidar', 'Karnataka', '585401', '+91-8050026166', 'Warehouse Manager', 10000, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- H2 syntax
ALTER TABLE locations ALTER COLUMN id RESTART WITH 7;
...
SELECT setval('locations_id_seq', 7, false);
